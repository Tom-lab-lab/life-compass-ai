...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "nav.simulator": "Life Simulator",
    "nav.cluster": "Behavior Cluster",
  ...
  ta: {
    ...
    "nav.simulator": "வாழ்க்கை சிமுலேட்டர்",
    "nav.cluster": "நடத்தை குழு",
    "nav.modelHealth": "மாதிரி ஆரோக்கியம்",
    "nav.researchMetrics": "ஆராய்ச்சி அளவீடுகள்",
    "nav.export": "ஆராய்ச்சி ஏற்றுமதி",
    "nav.weeklyFeedback": "வாராந்திர கருத்து",
    "nav.mcda": "MCDA மாதிரி",
  ...
  hi: {
    ...
    "nav.simulator": "जीवन सिमुलेटर",
    "nav.cluster": "व्यवहार समूह",
    "nav.modelHealth": "मॉडल स्वास्थ्य",
    "nav.researchMetrics": "शोध मेट्रिक्स",
    "nav.export": "शोध निर्यात",
    "nav.weeklyFeedback": "साप्ताहिक प्रतिक्रिया",
    "nav.mcda": "MCDA मॉडल",
